...
public class CompressionTool implements Handler.Callback {
  private static final String TAG = "QA";
  private static final String DEFAULT_DISK_CACHE_DIR = "flylo_disk_cache";
  ...
  private CompressionTool(Builder builder) {
  ...
  public static class Builder {
    ...
    private CompressionTool build() {
      return new CompressionTool(this);
    }
