...
public class PermissionTool {
    private AtomicInteger sRequestCode = new AtomicInteger(0);
    private SparseArray<Result> sResultArray = new SparseArray<>();
    private Set<String> sManifestPermissionSet;
    ...
    private PermissionTool(Object object) {
        mObject = object;
    }
    ...
    public PermissionTool(@NonNull Fragment fragment) {
        mObject = fragment;
    }

    public PermissionTool permissions(@NonNull String... permissions) {
        mPermissions = permissions;
        return this;
    }

    public PermissionTool result(@Nullable Result result) {
        mResult = result;
        return this;
    }
    ...
    private synchronized void initManifestPermission(Context context) {
