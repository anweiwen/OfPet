 ...
 */
public class ClassAdapter extends BaseRecyclerAdapter<Bean, ClassAdapter.ViewHolder> {

    public ClassAdapter(@NotNull List list) {
        super(list);
    }
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int i) {
        ...
        viewHolder.layout_item.setSelected(i == selectPosition);
    }
