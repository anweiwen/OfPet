 ...
 */
public class PrizeReceiveAdapter extends BaseRecyclerAdapter<Bean, PrizeReceiveAdapter.ViewHolder> {

    public PrizeReceiveAdapter(@NotNull List list) {
        super(list);
    }

    @Override
    public int layoutId(int viewType) {
        return R.layout.item_prize_receive;
    }
