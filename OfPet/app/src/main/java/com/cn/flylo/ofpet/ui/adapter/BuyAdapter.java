 ...
 */
public class BuyAdapter extends BaseRecyclerAdapter<Bean, BuyAdapter.ViewHolder> {

    public BuyAdapter(@NotNull List list) {
        super(list);
    }
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int i) {
        ...
        viewHolder.ivSelect.setSelected(i / 2 == 0);
    }
